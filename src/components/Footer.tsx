      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-serif text-xl font-medium">Artisan Brews</span>
            </div>
            <p className="text-gray-300 mb-4">
              Crafting memorable coffee experiences with carefully selected beans and artisan methods.
            </p>
          ...
          <div className="col-span-1">
            ...
            <address className="not-italic text-gray-300 space-y-2">
              ...
              <p>Email: hello@artisanbrews.com</p>
            </address>
          </div>
        ...
        <div className="pt-8 mt-8 border-t border-gray-700 text-sm text-gray-400">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p>&copy; {currentYear} Artisan Brews. All rights reserved.</p>
